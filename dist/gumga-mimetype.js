...
(function () {
    ...
    function MimeTypeService() {
        ...
        return { getMimeTypes: getMimeTypes, getExtensionsByMimeType: getExtensionsByMimeType, getExtensionByFileName: getExtensionByFileName, validate: validate };
    }

    angular.module('gumga.services.mimetype', []).factory('GumgaMimeTypeService', MimeTypeService);
})();
